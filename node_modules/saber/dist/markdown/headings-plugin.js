...
const permalinkRenderer = (slug, { permalinkBefore, permalinkClass, permalinkSymbol, permalinkHref, permalinkComponent }, // options
...
module.exports = (md, options = {}) => {
    ...
    md.core.ruler.push('headings', state => {
        ...
        for (let i = 0; i < tokens.length; i++) {
            ...
            const level = headingOpen.type === 'heading_open' && headingOpen.markup.length; // number of '#' defines level
