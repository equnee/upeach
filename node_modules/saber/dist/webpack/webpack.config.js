...
module.exports = (api, { type }) => {
    ...
    config.resolve.alias.set('saber/config$', api.resolveCache('config.json'));
    config.resolve.alias.set('saber/variables$', api.resolveCache('variables.json'));
    const ownModulesDir = path.join(path.dirname(require.resolve('vue/package')), '..');
