...
module.exports = babelLoader.custom(babel => {
    ...
    return {
        customOptions(opts) {
            ...
            const loader = Object.assign(custom.shouldCache
                ? {
                    cacheCompression: false,
                    cacheDirectory: path.join(custom.distDir, 'cache', 'saber-babel-loader'),
        ...
        config(cfg, { customOptions }) {
            ...
            options.presets.unshift(babel.createConfigItem([
