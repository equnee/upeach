...
exports.apply = api => {
    api.transformers.add('vue', {
        ...
        transform(page) {
            ...
            if (sfc.script) {
                const { data } = require('../utils/parseAttributes')(sfc.script.content, page.internal.absolute);
    ...
    api.transformers.add('js', {
        extensions: ['js'],
        transform(page) {
            const { data } = require('../utils/parseAttributes')(page.content, page.internal.absolute);
            Object.assign(page, data);
        },
        getPageComponent
    });
